...
public class EmailServiceImpl implements EmailService {
	...
	public void email_send(String name, String email) {
		...
		message.setTo(email);
		message.setFrom("whfu13@gmail.com");
	...
	public void email_send2(String name, String email) {
		...
		try {
			...
			String htmlData = "<tr>	<td style=\"width:700px;height:196px;padding:0;margin:0;vertical-align:top;\"> \r\n"
					+ "<table width='618' height='194' cellpadding='0' cellspacing='0' align='center' style='margin:0 0 0 40px;border:1px #D9D9D9 solid;'> <tr> <td style='width:618px;height:194px;padding:0;margin:0;vertical-align:top;font-size:0;line-height:0;background:#f9f9f9;'> \r\n"
					+ "<p style='width:620px;margin:30px 0 0 0;padding:0;text-align:center;'>\r\n"
					+ "<img src='../images/email/img_txt_password02.jpg' alt='JARDIN에서 비밀번호 찾기를 요청하셨습니다.' /></p> \r\n"
					...
					+ "<p style='width:620px;margin:30px 0 0 0;padding:0;text-align:center;color:#888888;font-size:12px;line-height:1.4;'>쟈뎅샵에서는 고객님께 보다 나은 서비스를 제공하기 위해 항상 노력하고 있습니다.<br/>앞으로 많은 관심 부탁드립니다.</p> </td> </tr> </table>		</td></tr>";
			
			message.setText(htmlData,"utf-8","html");
			// 보내는 이메일 주소
			message.setFrom(new InternetAddress("whfu13@gmail.com"));
			// 받는 이메일주소
